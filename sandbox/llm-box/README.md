...
> **Optional component:** If you already have [Ollama](https://ollama.com) installed and a model pulled on port `11434`, you can skip the sandbox entirely. Wren connects to `http://127.0.0.1:11434` regardless of whether the server is native or sandboxed.
