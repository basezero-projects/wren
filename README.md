...
- Highlight text anywhere, hit the hotkey, and Wren picks it up as a quote at the top of your message. Capture your screen and attach it the same way with `/screen` or the screenshot button.
