...
Report vulnerabilities privately via [GitHub Security Advisories](https://github.com/quiet-node/wren/security/advisories/new). This keeps the details confidential until a fix is ready.
...
Wren runs entirely on your local machine. There is no server, no cloud backend, and no telemetry. The attack surface is limited to:
